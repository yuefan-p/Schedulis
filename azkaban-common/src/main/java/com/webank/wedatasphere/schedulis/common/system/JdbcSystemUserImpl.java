...
public class JdbcSystemUserImpl implements SystemUserLoader {
    ...
    private static class WebankDepartmentHandler implements ResultSetHandler<List<WebankDepartment>> {
        ...
        private static final String FIND_WEBANK_DEPARTMENT_NO_ORG = BASE_SQL_FIND_ALL_WEBANK_DEPARTMENT + " WHERE pid=100000";
    ...
    public WebankUser getWebankUserByUserName(final String userName) throws SystemUserManagerException {
        ...
        try {
            ...
            webankUserList = this.dbOperator.query(findAllWebankUserHandler.FIND_WEBANK_USER_BY_NAME, new findAllWebankUserHandler(), userName);
    ...
    public List<Integer> getMaintainedProjects(String username) throws SystemUserManagerException {
        String querySql = "SELECT pr.id FROM projects pr "
                ...
                + "WHERE pr.active=1 and d.ops_user like '%" + username + "%'";
        try {
            return this.dbOperator.query(querySql, this::getProjectIds);
        } catch (SQLException e) {
